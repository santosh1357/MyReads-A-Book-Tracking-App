...
//Fetching Books Data
 ...
 updateBookShelf = (bookTitle, shelf) => {
    const selectedBookIndex = this.state.indexOf(bookTitle)
    if(selectedBookIndex !== -1 ){
      this.setState( (state) => ({
        books:state.books[selectedBookIndex].shelf = shelf
      })) 
    } else { 
      alert('unable to update shelf') 
    }    
 } 
